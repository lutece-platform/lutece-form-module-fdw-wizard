...
VALUES ('FDW_WIZARD_MANAGEMENT', 'module.fdw.wizard.adminFeature.fdw-wizard_management.name', '2', 'jsp/admin/plugins/fdw/modules/wizard/ManageWizard.jsp', 'module.fdw.wizard.adminFeature.fdw-wizard_management.description', '0', 'fdw-wizard', NULL, NULL, 'jsp/admin/documentation/AdminDocumentation.jsp?doc=admin-fdw-wizard', '4');
